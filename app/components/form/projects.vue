	...
	<UForm
		...
		<UFormField>
			<template
				...
				<FormCollapsible :label="state.projects[index]!.name || 'New Project'" class="my-2">
					<div class="flex flex-col gap-1 not-first:mt-4 mb-4">
						...
						<div class="flex">
							<div class="grow" />
							<FormClearInputButton :fn="() => { state.projects.splice(index, 1) }" trailing label="Remove Project" />
						</div>
					</div>
				</FormCollapsible>
			</template>
